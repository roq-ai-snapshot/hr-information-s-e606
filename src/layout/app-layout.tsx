...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['employee', 'business-owner', 'hr-manager', 'payroll-administrator', 'accountant'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Hr Data', path: '/hr-data', entity: 'hr_data', service: AccessServiceEnum.PROJECT, icon: FiFileText },
