...
export function useHrDataFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useHrDataFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hr_data.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useHrDataCount<T extends Prisma.hr_dataCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.hr_dataCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useHrDataCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hr_data.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useHrDataFindManyWithCount<
  T extends Prisma.hr_dataFindManyArgs,
  R extends { data: GetFindResult<Prisma.$hr_dataPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.hr_dataFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useHrDataFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hr_data.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useHrDataFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useHrDataFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.hr_data.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
