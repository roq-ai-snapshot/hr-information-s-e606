...
import type { Prisma, company, employee, hr_data, payroll, user, vacation } from './types';
...
interface Hr_dataSDK {
  create: <T extends Prisma.hr_dataCreateArgs, R extends CheckSelect<T, hr_data, Prisma.hr_dataGetPayload<T>>>(
    data: Prisma.SelectSubset<T, Prisma.hr_dataCreateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  createMany: <T extends Prisma.hr_dataCreateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.hr_dataCreateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  update: <T extends Prisma.hr_dataUpdateArgs, R extends Prisma.hr_dataGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.hr_dataUpdateArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  updateMany: <T extends Prisma.hr_dataUpdateManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.hr_dataUpdateManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  upsert: <T extends Prisma.hr_dataUpsertArgs, R extends Prisma.hr_dataGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.hr_dataUpsertArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  delete: <T extends Prisma.hr_dataDeleteArgs, R extends Prisma.hr_dataGetPayload<T>>(
    data: Prisma.SelectSubset<T, Prisma.hr_dataDeleteArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  deleteMany: <T extends Prisma.hr_dataDeleteManyArgs, R extends Prisma.BatchPayload>(
    args: Prisma.SelectSubset<T, Prisma.hr_dataDeleteManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findMany: <T extends Prisma.hr_dataFindManyArgs, R extends GetFindResult<Prisma.$hr_dataPayload<DefaultArgs>, T>[]>(
    args: Prisma.SelectSubset<T, Prisma.hr_dataFindManyArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  count: <T extends Prisma.hr_dataCountArgs, R extends number>(
    args: Prisma.SelectSubset<T, Prisma.hr_dataCountArgs>,
    options?: RequestOptions,
  ) => Promise<R>;

  findManyWithCount: <
    T extends Prisma.hr_dataFindManyArgs,
    R extends GetFindResult<Prisma.$hr_dataPayload<DefaultArgs>, T>[],
    C extends number,
  >(
    args: Prisma.SelectSubset<T, Prisma.hr_dataFindManyArgs>,
    options?: RequestOptions,
  ...
  findFirst: <T extends Prisma.hr_dataFindFirstArgs, R extends GetFindResult<Prisma.$hr_dataPayload<DefaultArgs>, T>>(
    args?: Prisma.SelectSubset<T, Prisma.hr_dataFindFirstArgs>,
    options?: RequestOptions,
  ) => Promise<R>;
}
...
export class RoqClient extends RoqPlatformClient {
  ...
  private initSDK() {
    ...
    this.hr_data = {
      create: async function createHr_data<
        T extends Prisma.hr_dataCreateArgs,
        R extends CheckSelect<T, hr_data, Prisma.hr_dataGetPayload<T>>,
      >(data: Prisma.SelectSubset<T, Prisma.hr_dataCreateArgs>, options?: RequestOptions) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/hr_data/create`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      createMany: async function createManyHr_data<
        T extends Prisma.hr_dataCreateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.hr_dataCreateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/hr_data/createMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      update: async function updateHr_data<T extends Prisma.hr_dataUpdateArgs, R extends Prisma.hr_dataGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.hr_dataUpdateArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/hr_data/update`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      updateMany: async function updateManyHr_data<
        T extends Prisma.hr_dataUpdateManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.hr_dataUpdateManyArgs>, options?: RequestOptions) {
        const response = await fetcher<R, false>(
          `${ctx.endpoint}/api/model/hr_data/updateMany`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'PUT',
      ...
      upsert: async function upsertHr_data<T extends Prisma.hr_dataUpsertArgs, R extends Prisma.hr_dataGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.hr_dataUpsertArgs>,
        options?: RequestOptions,
      ) {
        const response = await fetcher<R, true>(
          `${ctx.endpoint}/api/model/hr_data/upsert`,
          {
            ...ctx?.baseOptions,
            ...options,
            method: 'POST',
      ...
      delete: async function deleteHr_data<T extends Prisma.hr_dataDeleteArgs, R extends Prisma.hr_dataGetPayload<T>>(
        data: Prisma.SelectSubset<T, Prisma.hr_dataDeleteArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/hr_data/delete`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, true>(
          reqUrl,
          {
      ...
      deleteMany: async function deleteManyHr_data<
        T extends Prisma.hr_dataDeleteManyArgs,
        R extends Prisma.BatchPayload,
      >(data: Prisma.SelectSubset<T, Prisma.hr_dataDeleteManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/hr_data/deleteMany`;
        const reqUrl = makeUrl(url, data);
        const response = await fetcher<R, false>(
          reqUrl,
          {
      ...
      findMany: async function findManyHr_data<
        T extends Prisma.hr_dataFindManyArgs,
        R extends GetFindResult<Prisma.$hr_dataPayload<DefaultArgs>, T>[],
      >(args: Prisma.SelectSubset<T, Prisma.hr_dataFindManyArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/hr_data/findMany`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      count: async function countHr_data<T extends Prisma.hr_dataCountArgs, R extends number>(
        args: Prisma.SelectSubset<T, Prisma.hr_dataCountArgs>,
        options?: RequestOptions,
      ) {
        const url = `${ctx.endpoint}/api/model/hr_data/count`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
      ...
      findManyWithCount: async function findManyWithCountHr_data<
        T extends Prisma.hr_dataFindManyArgs,
        R extends GetFindResult<Prisma.$hr_dataPayload<DefaultArgs>, T>[],
        C extends number,
      >(args: Prisma.SelectSubset<T, Prisma.hr_dataFindManyArgs>, options?: RequestOptions) {
        const { distinct, orderBy, where } = args || {};
        const [data, count] = await Promise.all([
          ctx.hr_data.findMany(args, options),
          ctx.hr_data.count(
            {
              distinct,
              orderBy,
      ...
      findFirst: async function findFirstHr_data<
        T extends Prisma.hr_dataFindFirstArgs,
        R extends GetFindResult<Prisma.$hr_dataPayload<DefaultArgs>, T>,
      >(args?: Prisma.SelectSubset<T, Prisma.hr_dataFindFirstArgs>, options?: RequestOptions) {
        const url = `${ctx.endpoint}/api/model/hr_data/findFirst`;
        const urlWithArgs = makeUrl(url, args);
        const response = await fetcher<R, false>(
          urlWithArgs,
          {
